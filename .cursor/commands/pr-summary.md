...
1. **Save to `.dev/PR_SUMMARY.md`**. Update this file with the generated summary so it persists for the PR description and reviewers.
...
7. **Write to `PR_SUMMARY.md`**: Save the generated summary to `.dev/PR_SUMMARY.md`, then display it in your response
